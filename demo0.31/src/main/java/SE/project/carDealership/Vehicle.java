...
public abstract class Vehicle implements Serializable {
	...
	public static Vehicle getVehicle(int id) throws SQLException {
		return new VehicleDAO().getVehicleById(id);
	}

	public static int getInventorySize() throws SQLException {
		return new VehicleDAO().countVehicles();
	}
