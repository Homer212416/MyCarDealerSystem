...
public class DBManager {
	...
	public void runInsert(String query) throws SQLException {
		...
		stmt.execute(query);
		m_connection.commit(); // Ensure the transaction is committed
	...
	// dealerships(name PRIMARY KEY, location, capacity)
	private void createTables() throws SQLException {
		...
		var vehiclesSQL = "CREATE TABLE IF NOT EXISTS vehicles ("
				...
				+ "price REAL NOT NULL, "
				+ "type TEXT NOT NULL, "
				+ "handlebarType TEXT);"; // handlebarType can be null
