...
public class salesInventoryPage{
	private JFrame mainFrame;
	private JLabel headerLabel;
	private JLabel statusLabel;
	private JPanel controlPanel;

	public salesInventoryPage(){
		prepareInventoryGUI();
	}
	public static void main(String[] args){
      salesInventoryPage salesInventoryPage = new salesInventoryPage();
      //salesInventoryPage.showEventDemo();
	}
	...
	private void prepareInventoryGUI(){
		...
		carImage.setIcon(new ImageIcon(salesInventoryPage.class.getResource("/images/backgroundd.jpg")));
		...
		addVehiclePane.setEnabled(false);
		addVehicleBox.setEnabled(false);
		gbcS.gridx = 1;
		gbcS.gridy = 0;
