...
import SE.project.controller.FirstLaunchPageController;
...
public class FirstLaunchPage extends JFrame {
	...
	private FirstLaunchPageController controller;
	...
	public FirstLaunchPage() {
		this.controller = new FirstLaunchPageController();
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				try {
					...
					if (controller.createDealership(name, location, capacity)) {
