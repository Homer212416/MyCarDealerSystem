...
public class Dealership {
	...
	public String[] getInfoGUI() { // for gui
		...
		String[] info = {name, location, Integer.toString(inventory.length), Integer.toString(inventory.length - nv),Integer.toString(getTotalCars()),Integer.toString(getTotalMotorcycles()),Integer.toString(salesProfit()), Integer.toString(ns)}; 
		return(info);
	...
	public String[] displayAlls() { // FOr gui
		String[] vehicles = new String[inventory.length];
